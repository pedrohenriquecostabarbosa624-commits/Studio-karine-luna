...
def pagamento():
    ...
    # Define a taxa: 20 reais fixos, a não ser que o serviço seja mais barato que 20.
    taxa_agendamento = min(20.00, valor_total)
    restante_no_estudio = valor_total - taxa_agendamento

    email_limpo = re.sub(r'[^a-zA-Z0-9]', '', nome.lower()) + "@email.com"

    # Envia para o Mercado Pago APENAS o valor da taxa
    payment_data = {
        "transaction_amount": float(taxa_agendamento),
        "description": f"Sinal Agendamento - {procedimentos_str}",
